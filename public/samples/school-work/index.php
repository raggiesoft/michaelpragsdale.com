...
<body>
    ...
    <section class="container-fluid">
        <section class="row">
            <?php
					$rsSideBar = new SideNav("School Work", "fa-school",false, true);
					$rsSideBar->writeSideBarListOpening();
					$rsSideBar->writeSideBarListItem("Home", "/", "fa-home", false, true);
					$rsSideBar->writeSideBarListItem("TCC", "tcc/", "fa-clipboard-list-check");
					$rsSideBar->writeSideBarListItem("ODU", "odu/", "fa-clipboard-list-check");
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="pageStart">
				<article class="container">
					<h1><i class="fa-duotone fa-folder-gear me-2" aria-hidden="true"></i>School Work</h1>
					<p>Welcome to the assignments page for my Structured Query Language class. This will be where I post homework assignments that I&rsquo;ve turned in.</p>
					<!--Section: Assignment Packages-->
					<section class="text-center">
						<section class="row">
							<!-- Card 1 of 3 -->
							<section class="col-lg-6 col-md-12 mb-4">
								<section class="card">
                                    <section class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
										<img src="/education/logos/tcc.jpg" class="img-fluid" alt="Tidewater Community College logo" title="Tidewater Community College logo" />
										<section class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></section>
									</section>
									<section class="card-body">
										<h3 class="card-title">Tidewater Community College</h3>
										<p class="card-text">I went back to a community college to get a degree that says I know how to build websites like this one.</p>
										<a href="tcc/" class="btn btn-primary"><i class="fa-duotone fa-binoculars me-2" aria-hidden="true"></i>View Collection</a>
									</section>
								</section>
							</section>
							...
							<section class="col-lg-6 col-md-12 mb-4">
								<section class="card">
                                    <section class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
										<img src="/education/logos/odu.jpg" class="img-fluid" alt="Old Dominion University logo" title="Old Dominion University logo"/>
										<section class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></section>
									</section>
									<section class="card-body">
										<h3 class="card-title">Old Dominion University</h3>
										<p class="card-text">I attended a public 4 year university. Anticipated graduation: Summer 2025 (long story).</p>
										<a href="odu/" class="btn btn-primary"><i class="fa-duotone fa-binoculars me-2" aria-hidden="true"></i>View Collection</a>
									</section>
								</section>
							</section>
						</section>
