...
<main class="site-content" id="content">
    <div class="container"> 
        ...
        <div class="breadcrumb-nav" style="margin-bottom: 2rem;">
            <a href="/projects/" class="button button-outline-secondary">
                <i class="fa-duotone fa-arrow-left fa-fw"></i> Back to All Projects
            </a>
        </div>
