<?php // --- includes/document-close.php ---
 ...
 */?>
    ...
    <script src="/assets/js/main.js?v=<?php echo time(); ?>"></script> <?php // Use time() for development; switch to filemtime() in production for better caching ?>
</body>
</html>