...
<body>
    ...
    <section class="container-fluid">
        <section class="row">
            <?php
					$rsSideBar = new SideNav("TCC", "fa-school",false, true);
					...
					$rsSideBar->writeSideBarListItem("Spring 2025", "#spring2025", "fa-clipboard-list-check");
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="pageStart">
				<article class="container">
					<h1><i class="fa-duotone fa-folder-gear me-2" aria-hidden="true"></i>TCC School Work</h1>
					...
					<section class="text-center">
                        <h2 id="spring2025">Spring 2025</h2>
						<section class="row">
							<!-- Card 1 of 3 -->
							<section class="col-lg-4 col-md-12 mb-4">
								<section class="card">
									<section class="card-body">
										<h3 class="card-title">ITD 132 SQL</h3>
										<p class="card-text">I am learning Structured Query Language.</p>
										<a href="itd132/" class="btn btn-primary"><i class="fa-duotone fa-binoculars me-2" aria-hidden="true"></i>View Collection</a>
									</section>
								</section>
							</section>
						</section>
