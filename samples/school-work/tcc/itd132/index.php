    ...
    <section class="container-fluid">
        <section class="row">
            <?php
					...
					$rsSideBar->writeSideBarListItem("Get to Know Me", "2t1l.php", "fa-clipboard-list-check");
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="pageStart">
				<article class="container">
					<h1><i class="fa-duotone fa-folder-gear me-2" aria-hidden="true"></i>TCC ITD 132</h1>
					...
					<section class="text-center">
						<section class="row">
							...
							<section class="col-lg-4 col-md-12 mb-4">
								<section class="card">
									...
									<section class="card-body">
										...
										<p class="card-text">Get to Know Me and see a little SQL in action</p>
										<a href="2t1l.php" class="btn btn-primary"><i class="fa-duotone fa-binoculars me-2" aria-hidden="true"></i>View Assignment</a>
									</section>
								</section>
							</section>
							...
							<section class="col-lg-4 col-md-12 mb-4">
								<section class="card">
									<section class="card-body">
										<h3 class="card-title">Future Assignment</h3>
										<p class="card-text">The next assignment will go here</p>
										<a href="#!" class="btn btn-primary disabled"><i class="fa-duotone fa-ban me-2" aria-hidden="true"></i>View Assignment</a>
									</section>
								</section>
							</section>
