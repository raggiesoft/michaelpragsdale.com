    ...
    <section class="container-fluid">
        <section class="row">
            <?php
					...
					$rsSideBar->writeSideBarListItem("Terminal Cheat Sheet", "terminal-cheat-sheet.php", "fa-clipboard-list-check");
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="pageStart">
				<article class="container">
					<h1><i class="fa-duotone fa-folder-gear me-2" aria-hidden="true"></i>TCC IT 171</h1>
					<p>This is the Intro to Unix class I am taking</p>
				</article>
            </main>
        </section>
    </section>
